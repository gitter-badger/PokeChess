...
///// modified by Alicia to not allow piece to 
///// move illegal shape

  if(cfg.legalShape !== true) {
    cfg.legalShape = "snapback";
  }
//************************
...
///added by Alicia
  ...
  if (cfg.legalShape !== true && cfg.legalShapeDrag === 'snapback') {
    action = 'snapback';
    console.log("inside chessboardjs line 1247");
  }
